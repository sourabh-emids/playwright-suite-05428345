...
# Page object fixtures for each requirement
@pytest.fixture
def req001_homepage_page(page) -> "Req001HomepagePage":
    """Fixture for REQ-001 homepage page object."""
    from pages.req_001_homepage_page import Req001HomepagePage
    return Req001HomepagePage(page)


@pytest.fixture
def req002_navigation_page(page) -> "Req002NavigationPage":
    """Fixture for REQ-002 navigation page object."""
    from pages.req_002_navigation_page import Req002NavigationPage
    return Req002NavigationPage(page)


@pytest.fixture
def req003_cta_page(page) -> "Req003CtaPage":
    """Fixture for REQ-003 CTA page object."""
    from pages.req_003_cta_page import Req003CtaPage
    return Req003CtaPage(page)


@pytest.fixture
def req004_mobile_page(page) -> "Req004MobilePage":
    """Fixture for REQ-004 mobile page object."""
    from pages.req_004_mobile_page import Req004MobilePage
    return Req004MobilePage(page)


@pytest.fixture
def req005_contact_form_page(page) -> "Req005ContactFormPage":
    """Fixture for REQ-005 contact form page object."""
    from pages.req_005_contact_form_page import Req005ContactFormPage
    return Req005ContactFormPage(page)
