"""How We Deliver section renders in intended sequence."""
...
def how_we_deliver_sequence(page: Page) -> None:
    ...
    # Check order: heading, paragraph, sub-heading, list, link
    ...
    list_items = page.locator("text=How We Deliver").first.locator("xpath=..").locator("li").count()
    ...
    assert list_items >= 3, "Should have multiple list items in the section"
