"""Step definitions for issue_0046: Logo rail does not duplicate for screen readers."""
...
def logo_rail_no_duplication(page: Page) -> None:
    ...
    for logo in logos:
        ...
        if alt and alt.strip() and aria_hidden == "true":
            # This would be a duplication issue
            pass
